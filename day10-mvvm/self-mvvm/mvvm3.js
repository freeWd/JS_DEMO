...
// 1.1 主要是通过构建fragment - html碎片，将碎片中的特殊部分{{xx}}, v-model等都解析成正确的value后，append到html中
// 1.2 在解析值的时候，添加如被观察对象，配合 Object.defineProperty 当js中的值被修改时，触发事件将新value复制给fragment对应的标签上，html模板中的值就会自动修改
